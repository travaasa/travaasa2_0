  ...
  <section class="intro pad clearfix notheater">
      <div class="col span_8_of_9">
          ...
          <p>Mention “Modern Luxury" and receive <strong>$75 in extra credits</strong> when staying on a <strong>Your Travaasa Package</strong> or a <strong>Total Travaasa Package</strong> for up to two people. Credits include:</p>
            ...
            <p><a href="https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;rateCode=TTMLUX&amp;numberOfAdults=2" target="_blank" onclick="_gaq.push(['_link', AppendNavisKeywordToURL('https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;rateCode=TTMLUX&amp;numberOfAdults=2')]); return false;" style="margin-bottom:20px;" class="btn-jorah">BOOK TOTAL TRAVAASA</a>&nbsp;&nbsp;&nbsp;
            <a href="https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;rateCode=YTMLUX&amp;numberOfAdults=2" target="_blank" onclick="_gaq.push(['_link', AppendNavisKeywordToURL('https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;rateCode=YTMLUX&amp;numberOfAdults=2')]); return false;" class="btn-jorah">BOOK YOUR TRAVAASA</a><br><br><a class="btn-list scroll" href="/preferences">GET ON THE LIST</a></p>
      </div>
  </section>
</article>
</section>
