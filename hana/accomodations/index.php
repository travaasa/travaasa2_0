...
<article id="main">
  <section class="intro pad clearfix notheater">
          ...
          <p>The Town of Hana feels like it is a world away from the rest of Maui. So it is only appropriate that our accommodations should envelop you in a similar state of mind. Whether you are staying in one of our all-inclusive, luxurious cottages or checking in to one of our spacious suites, you will find the peace and quiet you deserve. <strong>Rooms are free of radios, clocks and TVs, so you can fully embrace the low-key vibe of Heavenly Hana.</strong></p>
    ...
    <div class="col span_2_of_5">
    	<div class="room-details">
            ...
            <ul class="description">
                <li>All-inclusive packages so you can sample the finest spa treatments, Travaasa experiences and meals without worry</li>
