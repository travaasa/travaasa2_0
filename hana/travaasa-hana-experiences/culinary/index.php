  ...
  <article id="main">
    <section class="intro pad clearfix">
      <div class="col span_6_of_9">
        ...
        <p>One of the best ways to experience a new culture is through its cuisine. Learn how to make some of Hawaii’s best-known dishes, from crave-worthy cocktails to traditional dishes. </p>
      </div>
    </section>
    ...
    <section class="group grey pad storylines experience-inner-tiles hana">
      <ul class="experience-nav">
        ...
        <li><a href="/hana/travaasa-hana-experiences/culinary" class="on">CULINARY</a></li>
