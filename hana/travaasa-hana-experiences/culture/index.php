...
<section id="content">
  <article id="main">
    ...
    <section class="group grey pad storylines experience-inner-tiles hana">
      ...
      <div>
        <article>
          <img data-original="/assets/images/exp_hana_culture_hula.jpg" src="/assets/images/exp_hana_culture_hula.jpg" alt="Hula Maui hula lessons" >
<<<<<<< HEAD
          <br />
=======
>>>>>>> c56a783599de4f587d715ea68d68648e65ca8e50
        ...
        <article>
          <img data-original="/assets/images/exp_hana_culture_lei_making.jpg" src="/assets/images/exp_hana_culture_lei_making.jpg" alt="Lei making" >
<<<<<<< HEAD
          <br />
          <h2>Lei Making</h2>
...
>>>>>>> c56a783599de4f587d715ea68d68648e65ca8e50
        ...
        <article>
          <img data-original="/assets/images/exp_hana_culture_bike_holoholo.jpg" src="/assets/images/exp_hana_culture_bike_holoholo.jpg" alt="Hana biking" >
<<<<<<< HEAD
          <br />
=======
>>>>>>> c56a783599de4f587d715ea68d68648e65ca8e50
          <h2>Bike Holoholo</h2>
          <p class="description"><em>Holoholo</em> loosely translates to cruising, and there is no place to cruise like Hana. A beach cruiser bicycle is your chariot to explore Hana with a local guide. Join us for this fun bike excursion as we visit a handful of local sites while learning about the land use, culture, history and stewardship of Hana and its people. You'll become acquainted with Hana's sugar plantation days, understand the diversity of plants, connect with the architecture, re-live festivals and get a closer look at local town life. Sights to see include the Plantation Guest House, Hana town center, Hana Ball Park, Hana Hongwanji Buddhist temple and Waikaloa Beach.</p>
        </article>
        <article>
          <img data-original="/assets/images/exp_hana_culture_creative_outlet_series.jpg" src="/assets/images/exp_hana_culture_creative_outlet_series.jpg" alt="Creative Outlet Series Maui hula dancing" >
<<<<<<< HEAD
          <br />
        ...
        <article>
          <img data-original="/assets/images/exp_hana_culture_ecology.jpg" src="/assets/images/exp_hana_culture_ecology.jpg" alt="Maui ecology" >
          <br />
=======
          <h2>Creative Outlet Series</h2>
          <p class="description">Some say creating artwork in a setting as beautiful as Hana's can be just as relaxing as a massage. That's why we offer you pressure-free ways to release your inner creative. You'll be inspired as you focus on the relation between your soul and your surroundings through your choice of artistic outlet, whether it’s writing, painting, drawing or another medium that fits your mode of expression. Release your thoughts and enjoy the freedom to express yourself through in a therapeutic setting. Best of all, no experience or talent is needed to create something amazing you can bring home to remind you of your Travaasa journey. Simply let go and let the beauty and serenity of Hana act as your muse.</p>
        </article>
        <article>
          <img data-original="/assets/images/exp_hana_culture_ecology.jpg" src="/assets/images/exp_hana_culture_ecology.jpg" alt="Maui ecology" >
>>>>>>> c56a783599de4f587d715ea68d68648e65ca8e50
        ...
        <article>
          <img data-original="/assets/images/exp_hana_culture_talk_story.jpg" src="/assets/images/exp_hana_culture_talk_story.jpg" alt="Hawaii talk story" >
<<<<<<< HEAD
          <br />
          <h2>Talk Story</h2>
