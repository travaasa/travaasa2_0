...
<section id="feature_carousel_1" class="feature_carousel clearfix">
    <div id="feature_carousel_content_1" class="feature">
    	<div class="slide"><img data-original="/assets/images/feature_hana_1600x640_flights_display.jpg" src="/assets/images/global/placeholder.gif" alt="Flights to Hana now available"></div>
    </div>
...
<section id="content">
    ...
    <section class="intro pad clearfix">
      ...
      <div class="pricing_grp col span_3_of_9">		<ul class="pricing clearfix">
          <li>
              <h2>INCLUSIVE</h2>
              <p>Starting at</p>
              <h3><sup>$</sup>600</h3>
