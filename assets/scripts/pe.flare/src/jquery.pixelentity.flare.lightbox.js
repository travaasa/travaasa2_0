(function ($) {
	...
	$.pixelentity.video.fallbackPlayer = "/Travasa/SITE/assets/scripts/pe.flare/video/jarisplayer.swf";
	...
	function Lightbox() {
		...
		function show(id) {
			...
			if (!$.pixelentity.browser.mobile) {
				content.find("div").on("click", "div", function(e) {
					closeButton();
				});
			}
		}
