  ...
  <section class="pad group">
    ...
    <table class="compare-table">  
      <tbody>
        ...
        <tr class="compare-table-row">
          <td class="compare-table-description-box">In-room complimentary bottled water &amp; organic fair-trade coffee</td>
          <td class="compare-table-check total_travaasa">✔</td>
          <td class="compare-table-check">✔</td>
        </tr>
        <tr class="compare-table-row">
        ...
        <tr class="compare-summary">
          <td>&nbsp;</td>
          <td class="compare-price"><p>Starting at</p><p class="compare-price-copy"><sup>$</sup>475</p></td>
          <td class="compare-price"><p>Starting at</p><p class="compare-price-copy"><sup>$</sup>250</p></td>
        </tr>  
     </tbody>
    </table>
    <a id="policies"></a>
