...
<article id="main">
  <section class="intro pad clearfix notheater">
          ...
          <p>Travaasa Experiential Resorts provide you with different rate and package selections so that you can customize your journey, and make the most of your time with us. <strong>Travaasa Austin welcomes guests age 16 and up.</strong><br><br><a class="btn scroll" href="#policies">View our policies</a></p>
  </section>
  <section class="pad group">
    ...
    <table class="compare-table">  
      <tbody>
        ...
        <tr class="compare-table-row">
          <td class="compare-table-description-box-inc">Unlimited access to a <a href="/austin/austinschedule/">robust schedule</a> of programs &amp; activities organized in our five experiential pillars: Adventure, Culinary, Culture, Fitness and Wellness</td>
        ...
        <tr class="compare-table-row">
          <td class="compare-table-description-box">Spacious, <a href="/austin/accomodations/">well-appointed accommodations</a></td>
          <td class="compare-table-check total_travaasa">✔</td>
          <td class="compare-table-check">✔</td>
        </tr>
        <tr class="compare-table-row">
        ...
        <tr class="compare-summary">
          ...
          <td class="compare-price"><p>Starting at</p><p class="compare-price-copy"><sup>$</sup>200</p></td>
        </tr>  
     </tbody>
    </table>
    <a id="policies"></a>
    ...
    <br>
        ...
        <ul>
          ...
          <li>Travaasa Austin requires that all guests be <strong>16 and older</strong>.</li>
          ...
          <li>Rates are exclusive of applicable taxes and an 18% daily service charge. The service charge is designed to cover access to regularly scheduled experiences and classes, local phone calls, access to fitness center, resort facilities, self parking and gratuities on all package components.</li>
