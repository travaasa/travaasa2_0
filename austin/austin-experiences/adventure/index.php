...
<head>
	...
	<title>Austin Adventures: Horseback Riding, Mountain Biking, Hiking, Archery </title>
	<meta name="keywords" content="travaasa, travel, resorts, hana, hāna, hawaii, austin, texas, Austin resort, Austin spa, travaasa Austin, Austin spa resort, experiential, hotel, Austin hotel, Austin conference center, Austin group meeting" />
	<meta name="description" content="Stay at Travaasa Experiential Resort and enjoy Austin Texas adventures and outdoor activities amidst the beautiful Texas Hill Country. " />
	<?php
...
<article id="main">
  <section class="intro pad clearfix">
      <div class="col span_6_of_9">
          ...
          <p>Get your blood pumping on a Texas Hill Country adventure. From horseback riding and archery to a sunrise hike through the Balcones Canyonlands, there are lots of ways to experience this beautiful area.</p>
      </div>
  </section>
  <section class="group grey pad storylines experience-inner-tiles austin">
    <ul class="experience-nav">
      <li><a href="/austin/austin-experiences/adventure/" class="on">ADVENTURE</a></li>
    ...
    <div>
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_challenge.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_challenge.jpg" alt="Austin zip line" >
        <br />
        <h2>Prickly Pear Challenge Course</h2>
      ...
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_trail-ride.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_trail-ride.jpg" alt="Austin horseback riding" >
        <br />
      ...
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_equine.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_equine.jpg" alt="Texas hill country horseback riding" >
        <br />
        <h2>Equine Encounters</h2>
      ...
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_bike-pump.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_bike-pump.jpg" alt="Bike pump track" >
        <br />
        <h2>Bike Pump Track</h2>
      ...
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_archery.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_archery.jpg" alt="Austin archery" >
        <br />
        <h2>Archery</h2>
      ...
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_hatchet.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_hatchet.jpg" alt="Hatchet Throwing at Travaasa" >
        <br />
        <h2>Hatchet Throwing</h2>
        <p class="description">Learn the fundamentals and techniques that create the foundation of hatchet throwing while connecting your mental and physical performance. Develop techniques to increase focus, patience, flexibility, concentration, and attention skills and understand why hatchet throwing can continually develop these simple concepts to heighten all aspects of their lives.</p>
      </article>
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_hiking.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_hiking.jpg" alt="Places to hike in Austin" >
        <br />
        <h2>Hill Country Hike</h2>
      ...
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_hiking_2.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_hiking_2.jpg" alt="Hiking trails Austin" >
        <br />
        <h2>Sunrise Hike</h2>
      ...
      <article>
        <img data-original="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_geocaching.jpg" src="https://ssl-travaasa.scdn4.secure.raxcdn.com/assets/images/exp_austin_adventure_geocaching.jpg" alt="Geocaching Austin" >
        <br />
        <h2>Geocaching Adventure</h2>
