...
<article id="main">
  ...
  <section class="group grey pad storylines experience-inner-tiles austin">
    ...
    <div>
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_challenge.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_challenge.jpg" alt="Austin zip line" >
        <br />
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_trail-ride.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_trail-ride.jpg" alt="Austin horseback riding" >
        <br />
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_equine.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_equine.jpg" alt="Texas hill country horseback riding" >
        <br />
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_bike-pump.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_bike-pump.jpg" alt="Bike pump track" >
        <br />
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_archery.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_archery.jpg" alt="Austin archery" >
        <br />
        <h2>Archery</h2>
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_hatchet.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_hatchet.jpg" alt="Hatchet Throwing at Travaasa" >
        <br />
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_hiking.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_hiking.jpg" alt="Places to hike in Austin" >
        <br />
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_hiking_2.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_hiking_2.jpg" alt="Hiking trails Austin" >
        <br />
        <h2>Sunrise Hike</h2>
      ...
      <article>
        <img data-original="http://static.travaasa.com/assets/images/exp_austin_adventure_geocaching.jpg" src="http://static.travaasa.com/assets/images/exp_austin_adventure_geocaching.jpg" alt="Geocaching Austin" >
        <br />
