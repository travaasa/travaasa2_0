...
-->
                        <h1 style="text-decoration: line-through;">Austin Resort Rooms in Texas Hill Country</h1>
                        <h2>TRAVAASA AUSTIN IS CLOSED FOR RENOVATIONS <br />AS OF SEPTEMBER 1ST, 2017</h2>
                        <a style="float:left;" class="btn-jorah scroll" href="/austin-renovation">READ ABOUT OUR RENOVATIONS</a> <a style="float:left; margin-left:30px;" class="btn-list scroll" href="/preferences">GET ON THE LIST</a>
                        <p>&nbsp;
                            <br/>
                        </p>
                        <p>&nbsp;
                    ...
                    <section class="grey pad group">
                        ...
                        <div class="col span_1_of_5 pricing_grp_sub">
                            ...
                            <!--<p class="clear"><a class="btn-jorah" href="https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;numberOfAdults=2" id="accommodations-austin-link1" target="_blank">CHECK RATES &amp; AVAILABILITY</a><script type="text/javascript">AppendNavisKeywordToLink("accommodations-austin-link1");</script></p>-->
                            <p class="clear"><a class="btn-jorah" href="http://travaasa.com/austin-renovation/">CHECK RATES &amp; AVAILABILITY</a></p>
                        </div>
                    </section>
                    <section class="grey pad group">
                        <div class="col span_2_of_5">
                        ...
                        <div class="col span_1_of_5 pricing_grp_sub">
                            ...
                            <!--<p class="clear"><a class="btn-jorah" href="https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;numberOfAdults=2" id="accommodations-austin-link2" target="_blank">CHECK RATES &amp; AVAILABILITY</a><script type="text/javascript">AppendNavisKeywordToLink("accommodations-austin-link2");</script></p>-->
                            <p class="clear"><a class="btn-jorah" href="http://travaasa.com/austin-renovation/">CHECK RATES &amp; AVAILABILITY</a></p>
                        </div>
                    </section>
                </article>
