...
<article id="main">
  <section class="intro pad clearfix notheater">
      ...
      <p>A Texas adventure is yours to discover through our signature <a href="http://travaasa.com/austin/austin-experiences/" target="_self">Travaasa Experiences</a>. Our inclusive (<a href="http://travaasa.com/austin/rates-and-packages/">Total Travaasa</a>) and a la carte (<a href="http://travaasa.com/austin/rates-and-packages/">Your Travaasa</a>) options give you the freedom to choose your level of adventure. See our <a href="http://www.travaasa.com/hana/hana-rates-and-packages/">rates and packages</a>. Begin your day with <a href="http://travaasa.com/austin/austin-experiences/spa-wellness/" target="_self">Yoga for the Mind and Body</a>, or a <a href="http://travaasa.com/austin/austin-experiences/fitness/" target="_self">Sunrise Hike</a>, then learn to play <a href="http://travaasa.com/austin/austin-experiences/culture/" target="_self">the harmonica, or study the flora and fauna of Texas Hill Country</a>. Looking to relax and rejuvenuate?  Travaasa offers the <a href="http://travaasa.com/austin/travaasa-spa-overview/" target="_self">finest spa treatments in all of Austin</a>.  As the sun begins to set the adventure continues with an afternoon equine encounter, evening fireside chats, and Texas Two Step.  These experiences and more are yours to enjoy with our inclusive Total Travaasa package, which nourishes mind, body and soul with experiences, meals and non-alcoholic drinks.</p>
      <p>Or, choose the <a href="http://travaasa.com/austin/rates-and-packages/#vDCZ4vCMeOFDyeGT.97">Your Travaasa</a> option and add experiences to your stay a la carte. </p>
...
<div class="col span_1_of_1"><a href="/pdf/Travaasa-Austin-Property-Map.pdf" class="btn fitwidth" target="_blank">Property Map</a></div>
  ...
  <section class="grey pad group">
    ...
    <div class="col span_2_of_5">
    	<div class="room-details">
            <h4>Trail View Room Accommodations</h4>
            <p>Features and amenities include:</p>
            <ul class="description">
