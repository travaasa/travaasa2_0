<header>
  ...
  <nav id="main_nav" class="clearfix">
    <ul class="location_selector_nav menu_top">
    	<li class="menu_main"><a href="/hana-legacy" id="current_location">HANA, MAUI</a>
        	<ul class="menu_sub">
    ...
    <div id="hana_location_nav" class="location_group_nav">
     <ul class="location_nav menu_top">
          <li><a class="lnk_gallery" href="/hana-legacy/hanaphotos">GALLERY</a></li>
          ...
          <li class="menu_main menu_plus"><a href="#" class="plus"><span>+</span></a>
              <ul class="menu_sub">
                  ...
                  <li><a class="lnk_locationinfo" href="/hana-legacy/hana-maui">HANA &amp; GETTING HERE</a></li>
