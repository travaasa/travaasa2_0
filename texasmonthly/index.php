      ...
      <div class="col span_8_of_9">
          ...
          <p>Mention “Texas Monthly" and receive <strong>$75 in extra credits</strong> when staying on a <strong>Your Travaasa Package</strong> or the <strong>Total Travaasa Package</strong> for up to two people. Credits include:</p>
              <ul>
                ...
                <p><a class="btn-jorah" style="margin-bottom:20px;" href="https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;rateCode=TTTXM&amp;numberOfAdults=2" id="texasmonthly-austin-link1" target="_blank">BOOK TOTAL TRAVAASA</a><script type="text/javascript">AppendNavisKeywordToLink("texasmonthly-austin-link1");</script>&nbsp;&nbsp;&nbsp;
                <a class="btn-jorah" href="https://www.phgsecure.com/IBE/bookingRedirect.ashx?propertyCode=AUSTC&amp;rateCode=YTTXM&amp;numberOfAdults=2" id="texasmonthly-austin-link2" target="_blank">BOOK YOUR TRAVAASA</a><script type="text/javascript">AppendNavisKeywordToLink("texasmonthly-austin-link2");</script><br><br><a class="btn-list scroll" href="/preferences">GET ON THE LIST</a></p>
      </div>
  </section>
</article>
</section>
